...
for device in devices:
    ...
    shellcmd(device,"am broadcast -a android.intent.action.RUN -e cmd 'foliage.MinimumScreenSize 0.065'")
    ...
    shellcmd(device,"am broadcast -a android.intent.action.RUN -e cmd 'grass.densityScale 0.3'")
    ...
    shellcmd(device,"am broadcast -a android.intent.action.RUN -e cmd 'r.DeviceFPSMax 30'")
